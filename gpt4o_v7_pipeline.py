pipeline = {
    ...
    "PreliminaryDiagnosis": {
        "prompt": {
            ...
            "keys": ["{diagnostic_criteria}", "{candidate_diseases}", "{present_illness}", "{phi_findings}", "{physical_examination}", "{pe_findings}"]
        },
        "return_json": True,
        "format": {"preliminary_diagnosis": list},
        "inp": ["diagnostic_criteria", "candidate_diseases", "present_illness", "phi_findings", "physical_examination", "pe_findings"],
    ...
    "FinalDiagnosis": {
        "prompt": {
            ...
            "keys": ["{diagnostic_criteria}", "{candidate_diseases}", "{preliminary_diagnosis}", "{present_illness}", "{phi_findings}", "{physical_examination}", "{pe_findings}", "{laboratory_tests}", "{lab_findings}", "{radiology}", "{rad_findings}"]
        },
        "return_json": True,
        "format": {"final_diagnosis": str, "confidence": float},
        "inp": ["diagnostic_criteria", "candidate_diseases", "preliminary_diagnosis", "present_illness", "phi_findings", "physical_examination", "pe_findings", "laboratory_tests", "lab_findings", "radiology", "rad_findings"],
        "out": "diagnosis",
    ...
    "ReDiagnose": {
        "prompt": {
            ...
            "keys": ["{diagnostic_criteria}", "{candidate_diseases}", "{recheck_item}", "{recheck_report}", "{preliminary_diagnosis}", "{pre_diagnosis}"]
        },
        "return_json": True,
        "format": {"final_diagnosis": str, "confidence": float},
        "inp": ["diagnostic_criteria", "candidate_diseases", "recheck_item", "recheck_report", "preliminary_diagnosis", "pre_diagnosis"],
        "reset_out": "diagnosis",
        "next": ["ConfidenceExceedsThreshold"]
    }
}
